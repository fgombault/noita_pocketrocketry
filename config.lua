...
-- modify_speed_values_too = 1

-- example: only modify explosion radius, but not damage or speed
-- modify_damage_values_too = 0
-- modify_speed_values_too = 0

-- example: when radius and damage are increased, speed is reduced. dangerous! funny!
modify_damage_values_too = 1
modify_speed_values_too = -1

-- example: only modifies radius and damage, leave speed out of it
-- modify_damage_values_too = 1
-- modify_speed_values_too = 0
